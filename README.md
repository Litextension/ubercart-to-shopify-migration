...
=== UberCart to Shopify Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopify-migration/ubercart-to-shopify-migration.html

== Description: UberCart to Shopify Migration Tool allows you to migrate your products, orders, customers and other data from UberCart to Shopify automatically.
